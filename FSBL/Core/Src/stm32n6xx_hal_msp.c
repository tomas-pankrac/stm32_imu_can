...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PeriphClkInitStruct.AdcClockSelection = RCC_ADCCLKSOURCE_IC7;
    PeriphClkInitStruct.AdcDivider = 1;
    PeriphClkInitStruct.ICSelection[RCC_IC7].ClockSelection = RCC_ICCLKSOURCE_PLL2;
    PeriphClkInitStruct.ICSelection[RCC_IC7].ClockDivider = 64;
...
void HAL_FDCAN_MspInit(FDCAN_HandleTypeDef* hfdcan)
{
  ...
  */
    ...
    PeriphClkInitStruct.FdcanClockSelection = RCC_FDCANCLKSOURCE_IC19;
    PeriphClkInitStruct.ICSelection[RCC_IC19].ClockSelection = RCC_ICCLKSOURCE_PLL4;
    PeriphClkInitStruct.ICSelection[RCC_IC19].ClockDivider = 50;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInitStruct) != HAL_OK)
    {
      Error_Handler();
    }
    ...
    */
    ...
    GPIO_InitStruct.Alternate = GPIO_AF6_FDCAN1;
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_FDCAN2;
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_FDCAN3;
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PeriphClkInitStruct.Spi1ClockSelection = RCC_SPI1CLKSOURCE_IC8;
    PeriphClkInitStruct.ICSelection[RCC_IC8].ClockSelection = RCC_ICCLKSOURCE_PLL2;
    PeriphClkInitStruct.ICSelection[RCC_IC8].ClockDivider = 16;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInitStruct) != HAL_OK)
    {
      Error_Handler();
    }
  ...
  */
    ...
    PeriphClkInitStruct.ICSelection[RCC_IC9].ClockDivider = 25;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInitStruct) != HAL_OK)
    {
      Error_Handler();
    }
    ...
    */
    ...
    handle_GPDMA1_Channel3.Init.Request = GPDMA1_REQUEST_SPI5_TX;
    ...
    handle_GPDMA1_Channel2.Init.Request = GPDMA1_REQUEST_SPI5_RX;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PB5(JTDO/TRACESWO)     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOF, GPIO_PIN_4|GPIO_PIN_7);
  ...
  else if(hspi->Instance==SPI5)
  {
    ...
    PF12     ------> SPI5_MISO
    */
    HAL_GPIO_DeInit(GPIOF, GPIO_PIN_14|GPIO_PIN_15|GPIO_PIN_12);
